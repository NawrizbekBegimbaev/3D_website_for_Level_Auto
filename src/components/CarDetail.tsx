...
export function CarDetail({ car }: { car: Car }) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 pt-28 pb-20 sm:px-8 sm:pt-32">
      <Link href="/catalog" className="mb-6 inline-flex items-center gap-1.5 text-sm text-muted hover:text-white">
        ← {t.car.back}
      </Link>
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-4 text-3xl font-semibold text-white">{formatPrice(car.priceUsd)}</p>
